...
CREATE TABLE `t_b_mini_user` (
  ...
  `avatarUrl` varchar(2000) COLLATE utf8_bin DEFAULT NULL COMMENT '用户头像地址',
  `openId` varchar(128) COLLATE utf8_bin DEFAULT NULL COMMENT 'openid',
  `unionId` varchar(128) COLLATE utf8_bin DEFAULT NULL COMMENT 'unionId',
