...
public class PayResultDO {
    private Integer id;

    private Integer unifiedInfoId;
    ...
    public Integer getUnifiedInfoId() {
        return unifiedInfoId;
    }

    public void setUnifiedInfoId(Integer unifiedInfoId) {
        this.unifiedInfoId = unifiedInfoId;
    }
