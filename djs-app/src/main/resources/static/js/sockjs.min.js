	...
	({
		...
		45 : [function (t, e) {
				...
				e.exports = {
					quote : function (t) {
						...
						i.test(e) ? (n || (n = o(i)), e.replace(i, function (t) {
								return n[t]
							})) : e
					}
				}
					...
					(function () {
						function i(t, e) {
							...
							if (!n("json")) {
								...
								if (!g)
									var C = h.floor, A = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334], N = function (t, e) {
											...
											if ("object" == typeof a && a)
												if (u = b.call(a), u != _ || p.call(a, "toJSON"))
													...
													if (N) {
														...
														l = a.getUTCFullYear(), c = a.getUTCMonth(), h = a.getUTCDate(), y = a.getUTCHours(), g = a.getUTCMinutes(), w = a.getUTCSeconds(), x = a.getUTCMilliseconds();
						...
						if (!l || l.global !== l && l.window !== l && l.self !== l || (u = l), a && !o)
							i(u, a);
						else {
							var c = u.JSON,
							f = u.JSON3,
		...
		56 : [function (t, e) {
				...
				function r(t, e, u) {
					...
					m = this,
					y = 0;
					"object" !== v && "string" !== v && (u = e, e = null),
					u && "function" != typeof u && (u = s.parse),
					e = o(e);
					var b = n(t);
					for (m.protocol = b.protocol || e.protocol || "", m.slashes = b.slashes || e.slashes, t = b.rest; y < l.length; y++)
						f = l[y], c = f[0], d = f[1], c !== c ? m[d] = t : "string" == typeof c ? ~(h = t.indexOf(c)) && ("number" == typeof f[2] ? (m[d] = t.slice(0, h), t = t.slice(h + f[2])) : (m[d] = t.slice(h), t = t.slice(0, h))) : (h = c.exec(t)) && (m[d] = h[1], t = t.slice(0, t.length - h[0].length)), m[d] = m[d] || (f[3] || "port" === d && p ? e[d] || "" : ""), f[4] && (m[d] = m[d].toLowerCase());
					u && (m.query = u(m.query)),
					i(m.port, m.protocol) || (m.host = m.hostname, m.port = ""),
					m.username = m.password = "",
					m.auth && (f = m.auth.split(":"), m.username = f[0] || "", m.password = f[1] || ""),
					m.href = m.toString()
				}
				...
				r.prototype.set = function (t, e, n) {
					var r = this;
					return "query" === t ? ("string" == typeof e && e.length && (e = (n || s.parse)(e)), r[t] = e) : "port" === t ? (r[t] = e, i(e, r.protocol) ? e && (r.host = r.hostname + ":" + e) : (r.host = r.hostname, r[t] = "")) : "hostname" === t ? (r[t] = e, r.port && (e += ":" + r.port), r.host = e) : "host" === t ? (r[t] = e, /\:\d+/.test(e) && (e = e.split(":"), r.hostname = e[0], r.port = e[1])) : "protocol" === t ? (r.protocol = e, r.slashes = !n) : r[t] = e,
					r.href = r.toString(),
					r
				},
